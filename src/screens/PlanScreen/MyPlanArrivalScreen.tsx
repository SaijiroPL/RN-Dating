  ...
  const temp_plans = [
    {
      ...
      imageUrl: `${GOOGLE_MAP_ENDPOINT.PLACE_PHOTO}?maxwidth=400&photoreference=CkQ0AAAABWA5MkM5PoM_NyLYq84qWgJK1PEEc9jW4dAkvT-UwYYzuEn2xUgW7k5n5VEsJ2zd_sb3ik09fD8F4B_7AOVPpxIQ2qMcKUs2-lLKT-MXIeK4LBoUuzEWL3lnCTfwKK1s7dcjwLWIN5E&key=${GOOGLE_MAP_ENDPOINT.KEY}`,
      latitude: 35.657303,
      like: false,
    ...
    },
    {
      ...
      imageUrl: `${GOOGLE_MAP_ENDPOINT.PLACE_PHOTO}?maxwidth=400&photoreference=CkQ0AAAAwucYngNJ3qQoSDQ49Oex6ZigD3VwANkdV-23mWP-4pvt5rx6talddK_gfuR9d7gl1wMEverbHNoH_7oo6TMwIBIQP927aqJKSu6YavjXVP9VZRoUDIEYXTDh9SHkAh2-noD6MJJZLIA&key=${GOOGLE_MAP_ENDPOINT.KEY}`,
      latitude: 35.6596632,
      like: false,
    ...
    },
    {
      ...
      imageUrl: `${GOOGLE_MAP_ENDPOINT.PLACE_PHOTO}?maxwidth=400&photoreference=CkQ0AAAAL07KcH6XLol2ReCOJn96wgOPVYrhOBT2iuPgbD2rjtVzA04SpwCo_vk1KHjg7R9cxHOfCH3j3xxFOOcJh8rynBIQjahcmYrM-GKDw1S4rH6JZBoU2dQMDi-DV9nBHHp0yT-hIKeqq7E&key=${GOOGLE_MAP_ENDPOINT.KEY}`,
      latitude: 35.6613642,
      like: false,
    ...
    },
    {
      ...
      imageUrl: `${GOOGLE_MAP_ENDPOINT.PLACE_PHOTO}?maxwidth=400&photoreference=CkQ0AAAA7daf8VvZB_hdU3sZ7_Jim31506iFsIqXfpVsPjMcgdeY5DM9z7Feu6boTs6ogrtWg5N8HKRYpawPJqa1oAqIbxIQVUznNpHo-OxJkus44HznZxoUe41bTFlXFklGEPE3N633XcT8rwU&key=${GOOGLE_MAP_ENDPOINT.KEY}`,
      latitude: 35.659315,
      like: false,
    ...
    },
    {
      ...
      imageUrl: `${GOOGLE_MAP_ENDPOINT.PLACE_PHOTO}?maxwidth=400&photoreference=CkQ0AAAA8lwmYMHm5Tq5M6JxB-xAtempBffp2WgHZh_3d_dhG8fQbVc7ZJIln66CvOA6JxS2mXsoAOei7mYtaK2G5ZTkCRIQ0Frv05HHFy3fMc-bMHBuABoUJxTrSf4NE-fE5qPf6flTzvdxxXI&key=${GOOGLE_MAP_ENDPOINT.KEY}`,
  ...
  return (
    <View style={thisStyle.container}>
      ...
      >
        ...
        >
          {direction.length
            ? direction.map((place: any) => renderDirection(place))
            : null}
      ...
      >
        <Button
          buttonStyle={[thisStyle.button, { backgroundColor: COLOR.greyColor }]}
          title="目的地に到着しました。"
        ></Button>
        <Button
